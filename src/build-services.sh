...
pushd "$SCRIPTDIR/productpage"
  docker build --pull -t "${PREFIX}/examples-bookinfo-productpage-v1:${VERSION}" -t "${PREFIX}/examples-bookinfo-productpage-v1:latest" -t "${PREFIX}/examples-bookinfo-productpage-v1:prod" .
  #flooding
...
pushd "$SCRIPTDIR/details"
  ...
  docker build --pull -t "${PREFIX}/examples-bookinfo-details-v1:${VERSION}" -t "${PREFIX}/examples-bookinfo-details-v1:latest" -t "${PREFIX}/examples-bookinfo-details-v1:prod" --build-arg service_version=v1 .
...
pushd "$SCRIPTDIR/reviews"
  #java build the app.
  #docker run --rm -u root -v "$(pwd)":/home/gradle/project -w /home/gradle/project-copy gradle:4.8.1 bash -c "cp -r -T /home/gradle/project ./ && gradle clean build"
  docker run --rm -u root -v "$(pwd)":/home/gradle/project -w /home/gradle/project gradle:4.8.1 gradle clean build
  pushd reviews-wlpcfg
    #plain build -- no ratings
    docker build --pull -t "${PREFIX}/examples-bookinfo-reviews-v1:${VERSION}" -t "${PREFIX}/examples-bookinfo-reviews-v1:latest" -t "${PREFIX}/examples-bookinfo-reviews-v1:prod" --build-arg service_version=v1 .
    #with ratings black stars
    docker build --pull -t "${PREFIX}/examples-bookinfo-reviews-v2:${VERSION}" -t "${PREFIX}/examples-bookinfo-reviews-v2:latest" -t "${PREFIX}/examples-bookinfo-reviews-v2:prod" --build-arg service_version=v2 \
	   --build-arg enable_ratings=true .
    #with ratings red stars
    docker build --pull -t "${PREFIX}/examples-bookinfo-reviews-v3:${VERSION}" -t "${PREFIX}/examples-bookinfo-reviews-v3:latest" -t "${PREFIX}/examples-bookinfo-reviews-v3:prod" --build-arg service_version=v3 \
	   --build-arg enable_ratings=true --build-arg star_color=red .
  popd
popd

pushd "$SCRIPTDIR/ratings"
  docker build --pull -t "${PREFIX}/examples-bookinfo-ratings-v1:${VERSION}" -t "${PREFIX}/examples-bookinfo-ratings-v1:latest" -t "${PREFIX}/examples-bookinfo-ratings-v1:prod" --build-arg service_version=v1 .
